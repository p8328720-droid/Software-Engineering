        ...
        <div class="col-md-5">
            <div class="card shadow-lg border-0">
                <div class="card-header text-center bg-gradient-orange text-white border-0">
                    ...
                    <h3 class="mb-0">Portal Admin</h3>
                    <p class="mb-0 mt-2 opacity-75">Login untuk mengelola sistem</p>
                </div>
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('admin.login') }}">
                        @csrf
                        <div class="mb-3"><label class="form-label"><i class="fas fa-envelope me-2 text-orange"></i>Email Admin</label><input type="email" name="email" class="form-control" placeholder="admin@example.com" value="{{ old('email') }}" required autofocus></div>
                        ...
                        <button type="submit" class="btn btn-primary w-100 py-2"><i class="fas fa-sign-in-alt me-2"></i> Login sebagai Admin</button>
                    </form>
                    <hr class="my-4">
            ...
            <div class="text-center mt-3"><small class="text-muted"><i class="fas fa-info-circle me-1"></i> Demo: admin@example.com / password</small></div>
        </div>
    </div>
</div>
@endsection