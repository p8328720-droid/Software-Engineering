...
@section('dashboard-content')
        ...
        <div class="col-md-3 mb-3">
            <div class="card stat-card border-0 h-100">
                <div class="card-body">
                    ...
                    <small class="text-muted">Mahasiswa: {{ number_format($stats['total_students']) }} | Teknisi:
                        {{ number_format($stats['total_technicians']) }}</small>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 mb-3">
            <div class="card border-0">
                <div class="card-header bg-white">
                    <h5 class="mb-0"><i class="fas fa-chart-bar text-orange me-2"></i>Top 5 Fasilitas Paling Sering Rusak
                    </h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-12">
            <div class="card border-0">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    {{-- PERBAIKAN 1: Route index admin reports --}}
                            ...
                            <tbody>
                                @forelse($recent_reports as $report)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- PERBAIKAN 2: Route show report yang sudah disatukan (atau admin specific kalau
                                            Anda bedakan di web.php) --}}
    ...
    <script>
        new Chart(document.getElementById('statusChart'), {
            ...
            data: {
                ...
                datasets: [{ data: [{{ $stats['pending_reports'] ?? 0 }}, {{ $stats['in_progress_reports'] ?? 0 }}, {{ $stats['completed_reports'] ?? 0 }}], backgroundColor: ['#6c757d', '#ffc107', '#28a745'], borderWidth: 0 }]
            },
