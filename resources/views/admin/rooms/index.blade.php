...
@section('dashboard-content')
    <div class="container-fluid px-0">
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.rooms.create') }}"
                        class="btn btn-primary fw-bold shadow-sm d-none d-md-inline-block">
                        Tambah Ruangan
                    </a>
                </div>
            </div>
        ...
        <x-data-table>
            <x-slot:header>
                <h6 class="mb-0 fw-bold small-caps"><i class="fas fa-list text-orange me-2"></i>Daftar Inventaris Ruangan</h6>
            </x-slot:header>
            <x-slot:thead>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-1 justify-content-center">
                            ...
                            <button class="btn btn-sm btn-light border p-1 px-2 text-danger"
