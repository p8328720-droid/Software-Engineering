                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="faculty" class="form-select @error('faculty') is-invalid @enderror">
                            ...
                            @foreach(['Fakultas Teknik','Fakultas Ekonomi','Fakultas Hukum','Fakultas Kedokteran','Fakultas Ilmu Komputer'] as $fak)
                                <option value="{{ $fak }}"
                                    {{ old('faculty', $user->faculty) == $fak ? 'selected' : '' }}>
                                    {{ $fak }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="major" class="form-select @error('major') is-invalid @enderror">
                            ...
                            @foreach([
                                ...
                                <option value="{{ $spesialis }}"
                                    {{ old('major', $user->major) == $spesialis ? 'selected' : '' }}>
                                    {{ $spesialis }}
                                </option>
                            @endforeach
                        </select>
...
(function () {
    ...
    function showSection(role) {
        Object.entries(sections).forEach(([key, el]) => {
            ...
            // Disable input/select di section yang tersembunyi
            // sehingga browser tidak mengirim nilainya saat form submit
    ...
    // Tampilkan section sesuai role saat halaman dimuat
    showSection(roleSelect.value);
 
    // Ganti section saat role diubah
