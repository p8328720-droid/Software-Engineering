...
<div class="row mb-4">
    <div class="col-md-3 mb-3">
        <div class="card text-center border-0"><div class="card-body"><i class="fas fa-flag-checkered fa-3x text-orange mb-2"></i><h5>Total Laporan</h5><h2 class="text-orange">{{ $stats['total_reports'] ?? 0 }}</h2></div></div>
    </div>
    <div class="col-md-3 mb-3">
        <div class="card text-center border-0"><div class="card-body"><i class="fas fa-spinner fa-3x text-warning mb-2"></i><h5>Dalam Proses</h5><h2>{{ $stats['in_progress_reports'] ?? 0 }}</h2></div></div>
    </div>
    <div class="col-md-3 mb-3">
