{{-- layouts/admin.blade.php — extends layouts.app --}}
@extends('layouts.app')
...
@push('styles')
    <style>
        /* ── Override body background for admin ── */
        body {
...
{{-- ═══════════════════════════════════════════════════════════
Main content — injects admin shell into app's @yield('content')
═══════════════════════════════════════════════════════════ --}}
@section('content')
    ...
    <div class="mobile-topbar">
        <div class="d-flex align-items-center gap-2">
            ...
            <span class="fw-semibold" style="color: var(--dark-gray);">Admin Panel</span>
        </div>
...
{{-- ═══════════════════════════════════════════════════════════
Sidebar JS (appended after app's own scripts)
═══════════════════════════════════════════════════════════ --}}
@push('scripts')
    <script>
